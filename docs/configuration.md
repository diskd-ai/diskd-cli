...
| `DISKD_VERSION` | Installer release tag, for example `v0.1.4`. |
...
This opens `https://app.iosya.com/oauth-apps` and waits for the authenticated
browser session to create diskd CLI credentials. Use the development app host
with:
